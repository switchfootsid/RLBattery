...
def main(type_flag):
	...
	total_years = 15 #total training years
	...
	if type_flag == 1:
		...
		dyna_price = [6.68, 6.68, 6.68, 6.68, 7.93, 8.34, 7.11, 8.29, 6.83, 7.79, 8.25, 7.48, 7.85, 7.32, 7.14, 7.7, 7.18, 7.25, 8.36, 8.1, 8.1, 7.82, 6.99, 7.75]		
		eta = 0.9
		E_cap = 6.4 
		P_cap = 3.0
		total_years = 15
